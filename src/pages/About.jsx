    ...
    <>
      ...
      <main className="pt-24 min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <p className="text-xl text-gray-500 mb-12">Helping everyone from students to the biggest businesses leverage modern technology to grow smarter.</p>
          
          <div className="prose prose-lg max-w-none text-gray-600">
            <h2 className="text-2xl font-bold text-secondary mt-8 mb-4">Our Vision</h2>
            <p>To become a trusted technology partner delivering Data Science, Automation & AI, and Software & Website Development solutions worldwide.</p>
            
            <h2 className="text-2xl font-bold text-secondary mt-12 mb-4">Our Mission</h2>
            <p>We believe that technology should be an enabler, not a bottleneck. Our mission is to democratize access to enterprise-grade software and data solutions for everyone from students to the biggest businesses, enabling them to make data-driven decisions and automate their workflows efficiently.</p>
